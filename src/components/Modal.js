...
const Modal = ({ isVisible, setIsVisible }) => {
  ...
  return (
    <div
      className={`${display} bg-white rounded z-[1000] fixed md:top-[20%] top-[17%] md:left-[25%] left-[10%] md:w-[50%] w-[80%] h-[75%] overflow-hidden pb-6`}
    >
      ...
      <div className="overflow-auto h-full p-4 [&>*]:pb-2">
        <p>
          ...
          The relative affordability of housing varies significantly from one
          municipality to the next, and sometimes between neighborhoods within
          the same municipality. At the same time, many different communities
          across the region struggle to come up with solutions to similar
          housing problems. DVRPC’s regional housing submarket analysis
          illuminates key aspects of the housing market in Greater Philadelphia
          to foster conversation and collaboration between communities
        ...
        <p>
          ...
          across the region. The goal of this analysis was to create a resource
          that could be easily understood by a range of stakeholders, including
          elected officials, government staff, and community members. For more
          information on DVRPC’s methodology, data inputs, and data sources,
          please visit this page.
        </p>
        <p>
          This type of submarket analysis has been conducted by a number of
          regional planning entities around the country and frequently serves as
          a foundation for housing policy conversations and research. As part of
          the preparation for this analysis, the project team spoke with staff
          from MPOs that have pioneered this type of assessment about their
        ...
        <p>
          ...
          perspective is intended to help provide individual municipalities with
          a more comprehensive understanding of the economic and social
        ...
        <p>
          ...
          issues related to transportation, the economy, and the environment. As
          such, achieving better housing outcomes is critical to realizing the
          equity, sustainability, and resiliency goals set in the{" "}
        ...
        <p>
          ...
          remove barriers to affordable housing and lower housing costs over the
          long term. Key next steps include working with our partners to
          identify and evaluate strategies that local governments can use to
          increase the supply and variety of housing options based on the nature
          of their housing challenges.
        </p>
        <p>
          For more information about DVRPC’s other housing-related work, please
          visit:
          <br />
          <a className="underline" href="">
